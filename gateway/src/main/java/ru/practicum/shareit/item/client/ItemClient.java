...
public class ItemClient extends BaseClient {
    ...
    public Mono<ResponseEntity<String>> get(String path, Integer userId, Map<String, Object> parameters) {
    ...
    public Mono<ResponseEntity<String>> patch(String path, Integer userId, String body) {
