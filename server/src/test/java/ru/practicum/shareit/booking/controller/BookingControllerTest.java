...
public class BookingControllerTest extends BookingBaseTest {
    ...
    @SneakyThrows
    @Test
    void create_shouldAnswerInternalServerErrorWhenUserIdIsMissing() {
        mvc.perform(post("/bookings")
                        .content(mapper.writeValueAsString(bookingDtoIn))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @SneakyThrows
    @Test
    void getById_shouldAnswerInternalServerErrorWhenUserIdIsMissing() {
        mvc.perform(get("/bookings/1")
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
    ...
    @SneakyThrows
    @Test
    void getAllByBooker_shouldAnswerInternalServerErrorWhenStateIsMissing() {
        doReturn(List.of(bookingDtoOut)).when(bookingService)
                .getAllByBooker(anyInt(), anyInt(), anyInt());
    ...
    @SneakyThrows
    @Test
    void getAllByBooker_shouldAnswerInternalServerErrorWhenUserIdIsMissing() {
        mvc.perform(get("/bookings")
                        .param("from", "0")
                        .param("size", "10")
                        .characterEncoding(StandardCharsets.UTF_8)
    ...
    @SneakyThrows
    @Test
    void getAllByOwner_shouldAnswerInternalServerErrorWhenStateIsMissing() {
        doReturn(List.of(bookingDtoOut)).when(bookingService)
                .getAllByOwner(anyInt(), anyInt(), anyInt());
    ...
    @SneakyThrows
    @Test
    void getAllByOwner_shouldAnswerInternalServerErrorWhenUserIdIsMissing() {
        mvc.perform(get("/bookings/owner")
                        .param("from", "0")
                        .param("size", "10")
                        .characterEncoding(StandardCharsets.UTF_8)
    ...
    @SneakyThrows
    @Test
    void setApproved_shouldAnswerInternalServerErrorWhenUserIdIsMissing() {
        mvc.perform(patch("/bookings/1")
                        .param("approved", "true")
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
